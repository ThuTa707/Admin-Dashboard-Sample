...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-4 offset-md-4">
            ...
            <div class="card">
                <div class="card-body">
                    <img src="{{ isset(Auth::user()->photo) ? asset('storage/profile/'.Auth::user()->photo) : asset('default/default-profile-pic.jpg') }}" class="d-block w-50 mx-auto rounded-circle my-3" alt="">
