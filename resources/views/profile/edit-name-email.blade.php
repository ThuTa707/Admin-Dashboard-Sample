...
@section('title') Edit Name and Email @endsection
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-4">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <form action="{{ route('profile.change.name-email') }}" method="post">
                        @csrf
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-4">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('profile.change.phone-address')}}" method="post">
                        @csrf
                        <div class="form-group">
                            <label for="phone">
